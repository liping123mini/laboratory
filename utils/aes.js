...
//   var decrypt = CryptoJS.AES.decrypt(srcs, key, {  mode: CryptoJS.mode.EBC, padding: CryptoJS.pad.Pkcs7 });
...
//   var encrypted = CryptoJS.AES.encrypt(srcs, key, {  mode: CryptoJS.mode.EBC, padding: CryptoJS.pad.Pkcs7 });
